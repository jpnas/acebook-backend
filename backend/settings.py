...
SPECTACULAR_SETTINGS = {
    'TITLE': 'AceBook API',
    'DESCRIPTION': 'API para gerenciamento de quadras, reservas e usuários do AceBook.',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "AceBook <no-reply@localhost>")
